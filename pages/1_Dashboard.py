...
# 3) Now that intraday is fully processed,
                ...
                with ticker_tabs[0]:
                    ...
                    scatter_40ish = go.Scatter(
                        ...
                        y=intraday.loc[mask_40ish, "F_numeric"] +92,
                        mode="markers",
                        marker_symbol="star",
                        marker_size=13,
                        marker_color="gold",
...
# # ------------------------------------------------------------------------------------------------------------------------
                    ...
                    scatter_tk_sun = go.Scatter(
                        ...
                        y=intraday.loc[mask_tk_sun, "F_numeric"] + 77,  # Offset for visibility
                        mode="text",
                        text="🌞",
                        textposition="top center",
                    ...
                    scatter_tk_moon = go.Scatter(
                        ...
                        y=intraday.loc[mask_tk_moon, "F_numeric"] - 77,  # Offset for visibility
                        mode="text",
                        text="🌙",
                        textposition="bottom center",
                        textfont=dict(size=28),
...
#                     fig.add_trace(scatter_red_king, row=1, col=1)
                 ...
                 # Create separate masks for upward and downward crosses:
                    ...
                    up_cross_trace = go.Scatter(
                        ...
                        y=intraday.loc[mask_kijun_up, "F_numeric"] + 44,  # Offset upward (adjust as needed)
                        mode="text",
                    ...
                    down_cross_trace = go.Scatter(
                        ...
                        y=intraday.loc[mask_kijun_down, "F_numeric"] - 44,  # Offset downward
                        mode="text",
...
# #**************************************************************************************************************************************************************************
                ...
                fig.update_layout(
                    ...
                    height=1050,  # Increase overall figure height (default ~450-600)
